...
import hera.com.orders.ShowPartnersByWeek;
...
public class PartnerByWeek {
    ...
    String jwtToken;
    hera.com.orders.infrastructure.sqlite.PartnerByWeek partnerByWeek;
    Context context;
    public static SQLiteDatabase db;
    public void connect(Context con)
    {
        context=con;
        partnerByWeek=new hera.com.orders.infrastructure.sqlite.PartnerByWeek();
        ...
        JsonArrayRequest strRequest = new JsonArrayRequest(Request.Method.GET, ShowPartnersByWeek.partner_week, (String) null,
